...
<div class="container">
  ...
  <form name="myform" method="post" action="openDiaryReWriteProc.diary" enctype="multipart/form-data">
    <table class="table table-bordered" style="width:800">
      ...
      <tr>
        <td colspan="2" class="text-center">
          ...
          <input type="button" onclick="location.href='openDiaryList.diary';" value="돌아가기" class="btn btn-info" />
        </td>
      </tr>
    </table>
