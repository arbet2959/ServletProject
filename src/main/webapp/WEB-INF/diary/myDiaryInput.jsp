...
<div class="container">
  ...
  <form name="myform" method="post" action="myDiaryInputProc.diary" enctype="multipart/form-data">
    <table class="table table-bordered" style="width:800">
      ...
      <tr>
        <td colspan="2" class="text-center">
          <input type="button" value="일기쓰기" onclick="fileCheck()"class="btn btn-success" /> &nbsp;
